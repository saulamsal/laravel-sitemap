...
.url:hover
{
  ...
  <body>
	<div id="content">
		...
		<p class="expl">Generated by <a href="https://github.com/pelazio/laravel-sitemap" target="_blank" title="Sitemap generator for Laravel">Pelazio-sitemap</a>. This is styled xml sitemap (for feature phones).</p>
